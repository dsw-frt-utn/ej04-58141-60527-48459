...
public abstract class Vehiculo {
    ...
    public Vehiculo(VehiculoTipo tipo, String patente, Marca marca, String modelo, int anio, double capacidadCarga, Sucursal sucursal, double kmRec) {
    ...
    public void setKmRec(double kmRec) {
        this.kmRec = kmRec;
    }
